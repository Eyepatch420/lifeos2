          ...
          FilledButton(
            ...
            onPressed: () async {
              ...
              final String path = await ShareService.shareAsFile(
                ...
                subject: 'DigiDaily backup — $total records',
              );
              if (context.mounted) {
  ...
  Future<void> _backupAndRestore(BuildContext context) async {
    ...
    final bool ok = await confirmDialog(
      ...
      message: mode == RestoreMode.overwrite
          ? 'Everything currently in DigiDaily on this device will be '
    ...
    await showDialog<void>(
      ...
      builder: (BuildContext ctx) => AlertDialog(
        ...
        content: Text(
          ...
          'Close and reopen DigiDaily to see your restored data.',
